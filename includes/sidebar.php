  ...
  <div class="sidebar w-64 h-screen bg-dark fixed flex flex-col">
        ...
        <nav class="flex-1 overflow-y-auto py-4">
            <ul class="space-y-1 px-2">
                <li>
                    <a href="trang_chu" class="sidebar-item flex items-center px-4 py-3 rounded-lg">
              ...
              <li>
                 <a href="warranty_management" class="sidebar-item flex items-center px-4 py-3 rounded-lg">
                        <!-- Icon Shield Check (bảo hành / đảm bảo) -->
